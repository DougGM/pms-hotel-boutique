 ...
 * consumido por cero, uno o varios productos. `current_quantity` es un
 * valor guardado — coincide con la suma de sus `inventory_movement`
 * (entradas menos salidas); la FASE 5 (WEB-11/WEB-12) lo verifica.
 */
