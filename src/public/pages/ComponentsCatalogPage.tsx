  ...
  return (
    <main className="ui-catalog">
      ...
      <section className="ui-catalog__section" id="forms" aria-labelledby="forms-title">
        <h2 id="forms-title">05 / Componentes de formulario</h2>
        <Card
          title="Pendientes de WEB-04"
          description="Los ejemplos se incorporarán cuando estén disponibles los componentes compartidos."
        >
          <div className="ui-catalog__row">
            {['Button', 'Input', 'Select', 'Modal', 'DatePicker'].map((name) => (
      ...
      <footer className="ui-catalog__footer">
        <Badge tone="warning">Tema provisional</Badge>
        <p>
          WEB-03 y WEB-04 están pendientes de integración. Este catálogo permite revisar el avance
          de WEB-13.
        </p>
      </footer>
    </main>
