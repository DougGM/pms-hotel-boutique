import { bookingMapper, type Booking, type CreateBookingDTO } from '@/shared/types/entities';
...
export const bookingService = {
  async getBookings(): Promise<Booking[]> {
    ...
    return mockBookings.map(bookingMapper.toDomain);
  },
  async getBookingById(id: ID): Promise<Booking | undefined> {
    ...
    return booking ? bookingMapper.toDomain(booking) : undefined;
  },
