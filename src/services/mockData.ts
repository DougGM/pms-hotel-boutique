...
export const mockBookings: BookingDTO[] = [{ id: 'booking-1', code: 'PMS-0001', guestId: 'guest-1', roomId: 'room-101', checkIn: '2026-09-10T15:00:00.000Z', checkOut: '2026-09-13T12:00:00.000Z', status: 'CONFIRMED', guests: 2, adults: 2, children: 0, pricePerNight: 950, totalAmount: 2850, currency: 'USD', source: 'direct', createdAt, updatedAt: createdAt, guest: mockGuests[0], room: mockRooms[0] }];
export const mockPayments: PaymentDTO[] = [{ id: 'payment-1', bookingId: 'booking-1', amount: 2850, currency: 'USD', method: 'CREDIT_CARD', status: 'COMPLETED', type: 'ROOM', description: 'Reserva PMS-0001', transactionId: 'TX-0001', createdAt, paidAt: createdAt }];
export const mockProducts: ProductDTO[] = [{ id: 'product-1', name: 'Agua mineral', description: 'Botella de 600 ml', category: 'MINIBAR', price: 15, currency: 'USD', stock: 24, active: true, createdAt, updatedAt: createdAt }, { id: 'product-2', name: 'Servicio express', category: 'ROOM_SERVICE', price: 75, currency: 'USD', stock: 999, active: true, createdAt, updatedAt: createdAt }];
