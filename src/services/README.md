...
estancia de forma idempotente; `createCharge`, `createPayment` y `voidCharge`
...
saldo esta saldado cierra la cuenta, marca la reserva como `checkedOut` y deja
la habitacion `available` + `dirty` para limpieza.
